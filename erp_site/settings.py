...
ALLOWED_HOSTS = ['ws-ftthec.onrender.com', 'localhost', '127.0.0.1', '.onrender.com']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '')  # Coloque no .env
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '')  # Coloque no .env
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
"""
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Para desenvolvimento
DEFAULT_FROM_EMAIL = 'contato@ftthec.com'
ADMIN_EMAIL = os.getenv('ADMIN_EMAIL', 'fernandoalexthec@gmail.com')